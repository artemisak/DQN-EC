...
from modules.utils import (load_and_process_results,
...
def run_comparison():
    """Run Metrics of different graph algorithms"""
    ...
    print("Starting graph algorithm Metrics...")
...
def visualize():
    ...
    if not json_files:
        print("No results files found. Please run the Metrics script first.")
    else:
